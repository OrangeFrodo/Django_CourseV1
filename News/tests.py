...
class TweetTestCase(TestCase):
    def setUp(self):
        ...
        tweet_obj = Tweet.objects.create(content="my tweet test 1", user=self.user, id=1)
        tweet_obj = Tweet.objects.create(content="my tweet test 2", user=self.user, id=2)
        tweet_obj = Tweet.objects.create(content="my tweet test 3", user=self.userb)
        self.currentCount = Tweet.objects.all().count()
    


    def test_tweet_created(self):
        tweet_obj = Tweet.objects.create(content="my tweet test", user=self.user)
